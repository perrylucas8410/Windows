...
# 4. DOWNLOAD VHDX DIRECTLY (21GB)
# This link is your Sunshine.vhdx direct download
...
if [ ! -f "/workspaces/Windows/windows/base.vhdx" ]; then
    echo '[SYSTEM] Downloading 21GB Base Image...'
    curl -L -o /workspaces/Windows/windows/base.vhdx "$URL"
    
    echo '[SYSTEM] Creating space-saving snapshot...'
    # This creates a tiny file that uses base.vhdx as its memory
    qemu-img create -f qcow2 -b /workspaces/Windows/windows/base.vhdx -F vhdx /workspaces/Windows/windows/snapshot.qcow2
fi
