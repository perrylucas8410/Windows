...
Since Codespaces are temporary, they will delete your data if they stop, and they stop after 30 minutes of inactivity. I recommend setting it to 240 minutes just in case. You can save and import the saved VM if you want to save data and give you a link which you can use on the vm-import codespace or just by using the vm-import command.
